...
// 	image -> color[COLOR_BLUE ][row][col] = barray[row * width + col];
          ...
          //Switching to flat arrays i*height*depth + j*depth + k [width*height*depth]
//           image -> color_flat[COLOR_RED*height*width + row*width + col] = rarray[row * width + col];
//           image -> color_flat[COLOR_GREEN*height*width + row*width + col] = garray[row * width + col];
//           image -> color_flat[COLOR_BLUE*height*width + row*width + col] = barray[row * width + col];
          
          image -> color_flat[COLOR_RED*8192*8192 + row*8192 + col] = rarray[row * width + col];
          image -> color_flat[COLOR_GREEN*8192*8192 + row*8192 + col] = garray[row * width + col];
          image -> color_flat[COLOR_BLUE*8192*8192 + row*8192 + col] = barray[row * width + col];
      }
    }
    //
    //  Free the memory.
...
//       barray[row * width + col] = image -> color[COLOR_BLUE ][row][col];
        ...
        //Switching to flat array
//         rarray[row * width + col] = image -> color_flat[COLOR_RED*height*width + row*width + col];
//         garray[row * width + col] = image -> color_flat[COLOR_GREEN*height*width + row*width + col];
//         barray[row * width + col] = image -> color_flat[COLOR_BLUE*height*width + row*width + col];
        
        rarray[row * width + col] = image -> color_flat[COLOR_RED*8192*8192 + row*8192 + col];
        garray[row * width + col] = image -> color_flat[COLOR_GREEN*8192*8192 + row*8192 + col];
        barray[row * width + col] = image -> color_flat[COLOR_BLUE*8192*8192 + row*8192 + col];
    }
  }
